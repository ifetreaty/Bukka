...
exports.addToCart = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let cart = yield cartRepository.cart(userId);
        console.log(cart, "heyy");
        let mealDetails = yield mealRepository.mealById(mealId);
        ...
        if (cart) {
            ...
            const indexFound = cart.items.findIndex((item) => item.mealId.id == mealId);
